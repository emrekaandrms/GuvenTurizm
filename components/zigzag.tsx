...
import FeatImage02 from '@/public/images/guven6.png'
        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="grid gap-20">
                ...
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <ul className="text-lg text-gray-550 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Müşterilerimizin iş verimliliğini arttırmak için yolda geçen zamanlarını minimuma indirgereyerek önce zaman diyoruz.</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Çalışanların iş yerlerine mutlu ve huzurlu bir şekilde ulaşmalarını sağlamaya özen göstererek hayat kalitelerine ve iş yerlerindeki verimliliklerine katkı sağlamaya çalışıyoruz.</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>0-5 yaş arası konforlu araçlarla personellerinizin ulaşımına katma değer katıyoruz.</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-550 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Uzun yolculuklarınıza uygun konforlu araçlar</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Sertifikalı ve eğitimli çalışanlarla güvenlik konusunda tecrübe</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Lokasyon fark etmeksizin sınırsız hizmet</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-550 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Araçlarımız, 0-5 yaş aralığında, turizm paketli, üç noktadan emniyet kemerli, deprem çantalı ve avandalıkları tam araçlardır.</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Araçlarımız, kendi tamirhane parkurumuzda profesyonel ustaların kontrolünde bakımları yapılmaktadır. </span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Araçlarımız, GPRS araç takip sistemleri ile takip edilmekte olup, anlık hız ve konumlarının takipi sağlanmaktadır.</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Araç parkımızda D2 belgeli (şehirlerarası yolculuk yapmak için gerekli belge), şehir içi sosyal etkinlik ve havaalanı transfer hizmetleri için Turizm Belgeli araçlar mevcuttur.</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              {/* Image */}
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
                <Image className="max-w-full mx-auto md:max-w-none h-auto" src={FeatImage05} width={540} height={405} alt="Features 02" />
              </div>
              {/* Content */}
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <ul className="text-lg text-gray-550 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Sürücü kadromuz, en az 5 yıl deneyimli, E ehliyet belgeli, sorumluluk sahibi, her ay değil hergün eğitim alan seçkin kişilerden oluşur.</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Sürücü seçimi, okul öncesi belirlediğimiz sınavlar ve eğitimlerden geçerek seçilir.</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Sürücülerimiz, etkili iletişim, defansif sürüş teknikleri, psikoteknik, ilk yardım eğitimlerinden geçerler.</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Sürücülerimiz, tek tip kıyafetli, hergün sakal traşı olmuş kişilerdir.</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Sürücülerimiz, profesyonel ve kendilerine bunu meslek edinmiş, her altı ayda bir sabıka kayıtları kontrol edilen kişilerdir.</span>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-550 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Rehber seçimi, okul öncesi belirlediğimiz sınavlar ve eğitimlerden geçerek seçilir.</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Rehberlerimiz, sağlık raporları tam (bulaşıcı hastalık vb.) ve her altı ayda bir sabıka kayıtları kontrol edilen kişilerdir.</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Rehberlerimiz, tek tip kıyafetli ve çağdaş giyimli kişilerdir.</span>
                    </li>
                    <li className="flex items-center">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                      </svg>
                      <span>Rehberlerimiz, etkili iletişim ve ilk yardım eğitimlerinden geçerler.</span>
                    </li>
                  </ul>
                </div>
              </div>
