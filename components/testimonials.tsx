        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              ...
              <blockquote className="text-lg text-gray-400 grow">2003 Yilinda tasimacilk sektörüne girdigimizde, on(10) yilk faaliyet plan ile isimize dörtelle sarilarak, sektörün ve Istanbul gibi Avrupa Metropolünün trafikteki sikintilanina ragmen güvenli ve kaliteli hizmet anlayis ile iki yüz(200) araçhk filo'ya ulasmanin gururunu tasimaktayiz. Amacimiz, firmalarm ve ailelerimizin bize emanet ettigi personel ve ögrencilerimizin, güvenli ve saglikh bir sekilde evlerinden isyerlerine ve okullarina gidis/dönüslerini saglamaktir. "Tasmacilk, ciddi kurumlarm isidir.", olgusu ile ise balayarak, önümüzdeki nesillere kadar bu ciddiyeti devretmenin onur ile bu güne kadar bize güvenen, aile ve firma sahiplerine tegekkürü borç bilirim.</blockquote>
